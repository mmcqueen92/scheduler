...
import { render, cleanup, waitForElement, fireEvent, getByPlaceholderText, getByText, getAllByTestId, getByAltText, queryByText, findByText, queryAllByText, getAllByText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduces the spots remaining for the first day by 1", async () => {
    ...
    const monday = getAllByTestId(container, "dayItem").find(day => queryByText(day, "Monday"))
  ...
  it("loads data, edits an interview and keeps the spots remaining for the first day by 1", async () => {
    ...
    await waitForElement(() => queryByText(appointment, "New student name"));
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    await waitForElement(() => queryByText(container, "Error"));
    expect(getByText(container, "Unable to delete appointment. Please try again.")).toBeInTheDocument();
